...
st.info(
    "Levli שומרת אוטומטית את תוצאות הסינון Monthly ו-Daily, כך שרענון/Reset לא מחייב להתחיל מחדש. "
...
st.info("מקור הנתונים הפונדמנטליים כרגע: העלאת CSV ידנית מ-Finviz.")
...
if "monthly_results_v08" in st.session_state:
    ...
    st.caption(
        ...
        "בנוסף SMA50 חייב להיות גבוה יותר מאשר לפני כ-3 חודשי מסחר; "
    ...
    if "daily_results_v08" in st.session_state:
        ...
        table(diagnostic_daily, [
            ...
            "Daily SMA50 Start", "Daily SMA50 Now", "Daily SMA50 Change %", "Daily Recent SMA50 Change %",
        ...
        for r in final_passed:
            ...
            out.update({
                ...
                "Daily Recent SMA50 Change %": r.get("Daily Recent SMA50 Change %"),
        ...
        table(final_rows, [
            ...
            "Daily Close", "Daily SMA50 Now", "Daily Distance %", "Daily SMA50 Change %", "Daily Recent SMA50 Change %",
        ...
        with st.expander("נפסלו בשלב Daily והסיבה"):
            table(daily_failed, [
                ...
                "Daily SMA50 Now", "Daily SMA50 Change %", "Daily Recent SMA50 Change %", "Daily Close", "Daily Distance %",
                "Daily Crossings", "Days Above SMA50 %",
            ])
